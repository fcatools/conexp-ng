package fcatools.conexpng.gui.lattice.algorithms.freese;
...
public class OrderedSet {
  ...
  private List elems;            // topologically sorted
  ...
  public OrderedSet(String name, List labels, List ucs) 
    ...
    setLowerCovers();
    setRanks();
    Collections.sort(elems, new Comparator() {
        public int compare(Object a, Object b) {
          return ((POElem)a).rank() - ((POElem)b).rank();
        }
      });
    setElemOrder();
    setLeq();
  ...
  public static OrderedSet orderedSetFromFilters(String name, List labels, 
    ...
    ans.setLowerCovers();
    ans.setRanks();
    Collections.sort(ans.elems, new Comparator() {
        public int compare(Object a, Object b) {
          return ((POElem)a).rank() - ((POElem)b).rank();
        }
      });
  ...
  public POElem one() {
    return (POElem)elems.get(card() - 1);
  }

  public POElem zero() {
    return (POElem)elems.get(0);
  }
